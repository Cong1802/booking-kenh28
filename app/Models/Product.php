...
class Product extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'slug', 'timePost', 'tax_type', 'total_price', 'sub_cat_id', 'brand_id', 'unit_id', 'tax_id', 'tax_type', 'regular_price', 'ads', 'price_difference', 'note', 'status', 'image_path','cat_id','vat_contract','code_contract','partner','employee','team'
    ];
    ...
    {
        return $this->belongsTo(ProductCategories::class, 'cat_id');
    }
    /**
     * Get the unit.
     */
    ...
    /**
     * Get the proEmoloyees.
     */
    public function proEmoloyees()
    {
